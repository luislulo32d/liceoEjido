...
document.addEventListener('DOMContentLoaded',function(){
    tableprofesores =  $('#tableprofesores').DataTable({
        ...
        "ajax":{
            "url": window.location.origin +"/administrador/models/profesores/table_profesores.php",
            "dataSrc":""
        },
        "columns": [
            {"data":"acciones"},
    ...
    formProfesor.onsubmit = function(e){
        ...
        var url =  window.location.origin +'/administrador/models/profesores/ajax-profesores.php';
...
function editarProfesor(id) {
   ...
   var request = (window.XMLHttpRequest) ? new XMLHttpRequest() : new ActiveXObject('Microsoft.XMLHTTP');
        var url = window.location.origin +'/administrador/models/profesores/edit-profesores.php?idprofesor='+idprofesor;
...
function eliminarProfesor(id) {
    ...
    swal({
        ...
        if(confirm) {
            var request = (window.XMLHttpRequest) ? new XMLHttpRequest() : new ActiveXObject('Microsoft.XMLHTTP');
            var url = window.location.origin +'/administrador/models/profesores/delet-profesor.php';
            request.open('POST',url,true);
