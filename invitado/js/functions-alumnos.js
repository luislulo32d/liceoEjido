document.addEventListener('DOMContentLoaded',function(){
    ...
    formAlumno.onsubmit = function(e){
        ...
        if(apellido == '' || nombre == '' || lugarNac == '' || entidadFederal == '' || nacionalidad == '' || cedulaes == '' || listSexo == '' || fecha_nac == '' || estado == ''){
            swal('Atencion','Todos los campos son necesarios','error');
            return false;
        }

        var request = (window.XMLHttpRequest) ? new XMLHttpRequest() : new ActiveXObject('Microsoft.XMLHTTP');
        var url = window.location.origin +'/liceoEutimioRivas/administrador/models/alumnos/ajax-alumnos.php';
...
function editarAlumno(id) {
   ...
   var request = (window.XMLHttpRequest) ? new XMLHttpRequest() : new ActiveXObject('Microsoft.XMLHTTP');
        var url = window.location.origin +'/administrador/models/alumnos/edit-alumnos.php?idalumno='+idalumno;
...
function eliminarAlumno(id) {
    ...
    swal({
        ...
        if(confirm) {
            var request = (window.XMLHttpRequest) ? new XMLHttpRequest() : new ActiveXObject('Microsoft.XMLHTTP');
            var url = window.location.origin +'/administrador/models/alumnos/delet-alumnos.php';
            request.open('POST',url,true);
