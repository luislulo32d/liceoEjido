...
document.addEventListener('DOMContentLoaded',function(){
    tableperiodos =  $('#tableperiodos').DataTable({
        ...
        "ajax":{
            "url": window.location.origin +"/administrador/models/periodos/table_periodos.php",
            "dataSrc":""
        },
        "columns": [
            {"data":"acciones"},
    ...
    formPeriodo.onsubmit = function(e){
        ...
        var url = window.location.origin +'/administrador/models/periodos/ajax-periodos.php';
