      ...
      <div class="modal-body">
        ...
        <input type="hidden" name="idalumno" id="idalumno" value="">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" name="lugarNac" id="lugarNac" maxlength="25" onKeyUp="document.getElementById(this.id).value=document.getElementById(this.id).value.toUpperCase()">
          </div>
          
          <div class="form-group">
            <label for="control-label">Municipio de Nacimiento:</label>
            <input type="text" class="form-control" name="municipio" id="municipio" maxlength="25" onKeyUp="document.getElementById(this.id).value=document.getElementById(this.id).value.toUpperCase()">
          </div>
          ...
          <div class="form-group">
            <label for="control-label">Cedula Estudiantil:</label>
            <input type="number" class="form-control" name="cedu_estudiantil" id="cedu_estudiantil">
          </div>
          
          <div class="form-group">
            <label for="control-label">Cedula De Identidad:</label>
          ...
          <div class="form-group">
            <label for="control-label">Telefono de Contacto:</label>
            <input type="number" class="form-control" name="listTelefContacto" id="listTelefContacto" maxlength="11" min=01000000001>
          </div>

          <div class="form-group">
            <label for="control-label">Dirección De Su Vivienda:</label>
            <input type="text" class="form-control" name="listDireccion" id="listDireccion" maxlength="99" onKeyUp="document.getElementById(this.id).value=document.getElementById(this.id).value.toUpperCase()">
          </div>
