...
document.addEventListener('DOMContentLoaded',function(){
    tableusuarios =  $('#tableusuarios').DataTable({
        ...
        "ajax":{
            "url": window.location.origin +"/liceoEjido/administrador/models/usuarios/table_usuarios_maxi.php",
            "dataSrc":""
        },
        "columns": [
            {"data":"acciones"},
    ...
    formUsuario.onsubmit = function(e){
        ...
        var url = window.location.origin +'/liceoEjido/administrador/models/usuarios/ajax-usuarios.php';
