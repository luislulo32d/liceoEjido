document.addEventListener('DOMContentLoaded',function(){
    tablematerias =  $('#tablematerias').DataTable({
        ...
        "ajax":{
            "url": window.location.origin + "/liceoEjido/administrador/models/materias/table_materias.php",
            "dataSrc":""
        },
        "columns": [
            {"data":"acciones"},
    ...
    formMateria.onsubmit = function(e){
        ...
        var url = window.location.origin +'/liceoEjido/administrador/models/materias/ajax-materias.php';
