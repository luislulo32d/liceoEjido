...
$sql = "SELECT * FROM cuarto_año as tp INNER JOIN alumnos as al ON tp.alumno_id = al.alumno_id INNER JOIN periodos as pe ON tp.periodo_id = pe.periodo_id WHERE pe.estado = 1 AND (statuscr = 1 OR statuscr = 2) ORDER BY aula_id";
